...
from domain_handler_msgs.msg import HumanInterfaceRequest, Confirmation, HumanInterfaceReply
...
mock_human_interface_pub = rospy.Publisher('/human_interface_confirmation', Confirmation, queue_size=1)
